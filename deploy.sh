#!/bin/zsh
# Deploy Acmon's Flask backend to the NAS (clipboard-style container "acmon", port 5054).
# scp/rsync don't work on UGOS, so files are uploaded via `ssh cat`.

NAS="Setu@10.0.0.10"
SRC="/Users/setugk/Seafile/Projects/Claude Code/acmon"
REMOTE="/volume1/docker/acmon"
SOCK="/tmp/acmon-deploy.sock"
...
log "Done. Acmon → http://10.0.0.10:5054"
